package Energeenot.MailSenderForEdo.sender;
...
public class Sender {
    ...
    // String uniqueCode, String toEmail, String fio, String numberGroup, String messageToTeacher
    public void sendNotificationOfNewDocuments(MessageDto dto){
        ...
        try {
            ...
            String numberGroup = dto.getNumberGroup();
            String messageToTeacher = dto.getMessageToTeacher();
            ...
            bodyPartMessage.setText("Ученик " + fio + "из " + numberGroup + " группы сдал документы на проверку," +
                    " введите код ниже на странице 'Валидатор' для проверки документов.");
    ...
    // String token, String toEmail
    public void sendNotificationOfResetPassword(MessageDto messageDto){
        Session session = getSession();
        try {
            String toEmail = messageDto.getToEmail();
    ...
    // String toEmail, String teacherName, String feedback
    public void sendFeedbackToStudent(MessageDto dto){
        Session session = getSession();
        try {
